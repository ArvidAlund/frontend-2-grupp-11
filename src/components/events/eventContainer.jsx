    ...
    >
      ...
      <div className="text-neutral-500 flex flex-col justify-between items-end gap-2">
        ...
        <div className="flex items-center text-white gap-2 mt-4">
          <p>Status:</p>
          <span className={`h-3 aspect-square rounded-full ring-2 ${type === "past" ? "ring-green-500" : "ring-neutral-500"} flex items-center justify-center overflow-hidden`}>
            {type === "past" ? <Check className="w-3 h-3 bg-green-500 rounded-full" /> : null}
          </span>
        </div>
      </div>
    </div>
